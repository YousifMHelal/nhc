    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-3">
        ...
        <KpiCard
          ...
          value={`${KPI_DATA.openOpportunities} فرصة`}
          growth={undefined}
          icon={Target}
        ...
        <KpiCard
          ...
          value={`${KPI_DATA.campaignPerformance}٪`}
          growth={KPI_DATA.campaignPerformanceGrowth}
          icon={Megaphone}
        ...
        <KpiCard
          ...
          value={`${(KPI_DATA.revenueThisMonth / 1_000_000).toFixed(1)} م ريال`}
        ...
        <KpiCard
          ...
          value={`${(KPI_DATA.openOpportunitiesValue / 1_000_000).toFixed(0)} م ريال`}
          growth={undefined}
          icon={BarChart2}
          accentClass="text-brand"
          accentBgClass="bg-blue-50"
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-5">
        ...
        <div className="lg:col-span-3 rounded-xl border border-border bg-card p-5">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={REVENUE_TREND} barSize={32}>
